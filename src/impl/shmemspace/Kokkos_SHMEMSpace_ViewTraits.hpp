...
#ifndef KOKKOS_REMOTESPACES_SHMEM_VIEWTRAITS_HPP
#define KOKKOS_REMOTESPACES_SHMEM_VIEWTRAITS_HPP
...
struct ViewTraits<void, Kokkos::Experimental::SHMEMSpace, Properties...> {
  static_assert(
